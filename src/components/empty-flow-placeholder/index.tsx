  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="flex flex-col py-4 mt-10 text-2xl font-medium tracking-tight text-center text-transparent bg-gradient-to-br from-slate-300 to-slate-500 bg-clip-text md:text-7xl"
      >
        No flow available <br /> now!
        <p className="mt-10 text-sm tracking-wide">
          You need to get your SOP reviewed and listed first.
        </p>
      </motion.h1>
      <motion.h1
        initial={{ opacity: 0.5, y: 100 }}
      ...
      >
        <div
          className="relative inline-flex items-center justify-center gap-4 transition-all duration-200 ease-in-out transform scale-100 group "
          role="button"
          onClick={() => {
